...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Concept_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_concept_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-concept' ),
				'next'     => esc_html__( 'Next Font', 'gt-concept' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-concept' ),
			);

			// Set Fonts.
			$this->fonts = GT_Concept_Custom_Fonts::get_available_fonts();
