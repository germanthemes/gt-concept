...
add_filter( 'body_class', 'gt_concept_body_classes' );
 ...
 * @return bool
 */
function gt_concept_is_blog_page() {
 ...
 * @return void
 */
function gt_concept_hide_elements() {
	...
	$elements = apply_filters( 'gt_concept_hide_elements', $elements );
	...
	// Add Custom CSS.
	wp_add_inline_style( 'gt-concept-stylesheet', $custom_css );
}
add_filter( 'wp_enqueue_scripts', 'gt_concept_hide_elements', 11 );
